...
r_outer = 0.25; // radius of outer circle
r_out = 0.2; // radius of refined area
r_in = 0.1; // radius of inner circle 
H = 0.1; // height of cylinder
nb_slices_quarter = 70; //number of layers in one quarter OF CIRCLE
nb_rings = 30; // number of concentric cell rings
...
Transfinite Line {1,2,3,4} = Ceil(nb_rings+1) Using Progression 1;
...
Transfinite Line {25,26,27,28} = 12 Using Progression 1.05;
