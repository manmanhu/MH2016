[Mesh]
  type = FileMesh
  file = Cnoidal_thin_mesh3_refine_1.msh
...
[Variables]
  active = 'disp_y disp_x porepressure damage'
  [./disp_x]
  [../]
  [./disp_y]
  [../]
...
[Functions]
  ...
  [./timestep_function]
    ...
    type = ParsedFunction
    value = 5e-4 # if(t<0.07, 2e-3, 5e-4)
  [../]
  [./outer_pressure_fct]
    type = ParsedFunction
    value = 1e-3
...
[Kernels]
  active = 'damage_dt damage_kernel dp_dt mass_diff'
  [./dp_dt]
    type = TimeDerivative
