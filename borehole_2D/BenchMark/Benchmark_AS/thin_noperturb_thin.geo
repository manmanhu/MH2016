...
r_outer = 0.16; // radius of outer circle
r_out = 0.13; // radius of refined area
r_in = 0.1; // radius of inner circle 
H = 0.1; // height of cylinder
nb_slices_quarter = 56; //number of layers in one quarter OF CIRCLE
nb_rings = 16; // number of concentric cell rings
...
Transfinite Line {1,2,3,4} = Ceil(nb_rings+1);
...
Transfinite Line {25,26,27,28} = 16; //Using Progression 1.05;
