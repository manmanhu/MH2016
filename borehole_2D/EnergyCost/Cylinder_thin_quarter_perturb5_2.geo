...
nb_slices_quarter = 50; //number of layers in one quarter OF CIRCLE
nb_rings = 13; // number of concentric cell rings
...
alpha = 1; //Frequency
M = 0;
M1 = 0;//0.0003; //0.01;//Amplitude
n = 90;//8; //number of pieces in one period
