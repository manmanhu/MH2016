...
nb_slices_quarter = 81; //number of layers in one quarter OF CIRCLE
nb_rings = 27; // number of concentric cell rings
...
Transfinite Line {25,26,27,28} = 10; //Using Progression 1.05;
