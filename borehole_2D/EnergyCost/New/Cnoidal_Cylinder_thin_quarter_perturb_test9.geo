...
nb_slices_quarter = 54; //number of layers in one quarter OF CIRCLE
nb_rings = 18; // number of concentric cell rings
...
Transfinite Line {25,26,27,28} = 8; //Using Progression 1.05;
