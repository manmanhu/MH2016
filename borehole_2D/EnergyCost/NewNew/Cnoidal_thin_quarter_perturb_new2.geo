...
nb_slices_quarter = 16; //number of layers in one quarter OF CIRCLE
nb_rings = 5; // number of concentric cell rings
...
Transfinite Line {25,26,27,28} = 3; //Using Progression 1.05;
