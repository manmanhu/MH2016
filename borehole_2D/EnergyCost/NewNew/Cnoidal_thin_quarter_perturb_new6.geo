...
nb_slices_quarter = 80; //number of layers in one quarter OF CIRCLE
nb_rings = 25; // number of concentric cell rings
...
For i In {1:n_points1}
 ...
 If(i==4||i==12||i==20||i==28||i==36||i==44||i==52||i==60||i==68||i==76)
   r = r+0.001;
  EndIf
  pList_1[i] = newp;
...
Transfinite Line {25,26,27,28} = 15; //Using Progression 1.05;
