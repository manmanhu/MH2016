...
r_outer = 0.8; // radius of outer circle
r_out = 0.2; // radius of refined area
r_in = 0.1; // radius of inner circle 
H = 0.1; // height of cylinder
nb_slices_quarter = 30; //number of layers in one quarter OF CIRCLE
nb_rings = 15; // number of concentric cell rings
...
Transfinite Line {21,22,23,24} = Ceil(nb_slices_quarter+1) Using Progression 1;
Transfinite Line {25,26,27,28} = 20 Using Progression 1.1;
...
Physical Line(0) = {5, 8, 7, 6};
Physical Line(1) = {21, 24, 23, 22};
Physical Surface(0) = {14, 20, 18, 16, 34, 32, 38, 36};
Delete {
  Line{5, 6, 3, 2, 1, 4};
}
Delete {
...
Delete {
  Line{3, 1, 4, 2, 6, 5, 8, 7};
}
Delete {
  Point{41, 40, 39, 38, 37, 36, 35, 34, 33, 32, 31, 30, 29, 28, 27, 26, 25, 24, 23, 22, 21, 20};
}
Delete {
  Point{19, 18, 17, 16, 15, 14, 2, 141, 140, 139, 138, 137, 136, 135, 134};
}
Delete {
  Point{133, 132, 131, 130, 129, 128, 127, 126, 125, 124, 123, 122, 121};
}
